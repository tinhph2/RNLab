...
import {styles} from '../lab8/styles82';
const Lab82 = () => {
  ...
  const handleNew = () => {
    ...
    // Gọi đến API hoặc thay đổi dữ liệu JSON tại đây
  ...
  return (
    <ScrollView>
      <TouchableOpacity style={styles.buttonNew} onPress={handleNew}>
